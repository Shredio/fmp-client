 ...
 *
 * @extends Type<PeersBulk>
 */
final readonly class PeersBulkMapper extends Type
{
	public function parse(mixed $valueToParse, TypeContext $context): ErrorElement|PeersBulk
	{
		...
		$schema = $ts->arrayShape(
			...
			'peers' => $ts->list($ts->nonEmptyString()),
		],
			identifier: 'symbol',
		);
		...
		return new PeersBulk(...$values);
	}


	protected function getTypeNode(TypeContext $context): TypeNode
	{
		return new IdentifierTypeNode(PeersBulk::class);
	}
}
