 ...
 * @extends Type<Index>
 */
final readonly class IndexMapper extends Type
{
	public function parse(mixed $valueToParse, TypeContext $context): ErrorElement|Index
	{
	...
	{
		return new IdentifierTypeNode(Index::class);
	}
}
