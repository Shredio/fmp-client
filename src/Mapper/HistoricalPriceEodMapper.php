 ...
 *
 * @extends Type<HistoricalPriceEod>
 */
final readonly class HistoricalPriceEodMapper extends Type
{
	public function parse(mixed $valueToParse, TypeContext $context): ErrorElement|HistoricalPriceEod
	{
